        ...
        <Grid >
          <Paper elevation = {10} className="signUp__page">
            <Grid className="signUp__content p-5">
              ...
              <TextField className='mt-4 p-2'
              label = 'User name' placeholder='Nguyen Van A'
                 required fullWidth
              />
              <TextField className='mt-4 p-2' label = 'email' type='email' placeholder='nguyenvana@gmail.com'
                 required fullWidth
              />
               <TextField className='mt-4 p-2' label = 'Password' type='password' placeholder='********'
                 required fullWidth
              />
              <FormControlLabel className='mt-4' style={{float: 'left'}}
